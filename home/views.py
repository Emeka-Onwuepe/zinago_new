...
from publication.models import Section, Article
from applications.form import application_form
...
def articleView(request, article_id, article_slug):
    ...
    return render(request, "home/articleview.html", {"article": article,
